...
; KRNBOOT_SECTORS) to $4200, and jumps to the bootstrap entry point
; at $4206. KRNBOOT_SECTORS grew from 1 to 3 as part of the
...
#define     KERN_LOAD   $4200           ; kernel bootstrap loads here
#define     KERN_ENTRY  $4206           ; kernel bootstrap entry point
